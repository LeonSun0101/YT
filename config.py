...
epoch=500
Init_lr=0.001
description='using new dataset and val and new loss'
data_loader='1_y'
input='YT'#Y
...
#test_dir='/home1/sas/datasets/YT-png/data_Augmentation/day_val/'
#test_dir='/home1/sas/results/test/9/'
